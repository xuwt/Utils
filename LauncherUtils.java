package com.baidu.hao123tejia.utils;
...
public class LauncherUtils {
    ...
    private static LauncherUtils mInstance = null;

    private LauncherUtils(Context context) {
        mContext = context;
    }

    public static synchronized LauncherUtils getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new LauncherUtils(context);
        }
        return mInstance;
    }
    /**
